...
void            procdump(void);
void            kvmclearuserpage(pagetable_t, uint64);
int             kvmcopypages(pagetable_t, pagetable_t, uint64, uint64);
...
// vm.c
void            kvminit(void);
pagetable_t     kvminit_1(void);
void            kvminithart(void);
void            kvminithart_1(pagetable_t);
uint64          kvmpa(uint64);
void            kvmmap(uint64, uint64, uint64, int);
void            kvmmap_1(pagetable_t, uint64, uint64, uint64, int);
